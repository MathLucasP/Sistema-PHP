...
<head>
    ...
    <script src="../JS/valida_cep.js"></script>
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown mx-auto p-2" id="Dropdown">
          ...
          <ul class="dropdown-menu" id="item-drop">
            <li><a class="dropdown-item sob disabled" href="../CADASTROS/Cadastro_Cliente.php">Cliente</a></li>
...
?>
    ...
    <form class="row g-3" id="formulario-cadastro" action="#" enctype="multipart/form-data" method="POST">
  <div id="voltar">
    <a href="../menu.php">
      <button class="btn btn-primary btn-warning" type="button" id="voltar">Voltar</button>
    </a>
  </div>
  <div class="main-formulario" id="formulario-cadastro">
    <div class="form-section">
      ...
      <div>
        ...
        <input type="text" class="form-control" id="inCPF" name="inCPF" maxlength="11" placeholder="EX: 99877542790" onfocusout="TestaCPF(this.value);" required>
      </div>
      <div>
        <label for="validationDefault03" class="form-label">RG</label>
        <input type="text" class="form-control" id="inRG" name="inRG" maxlength="9" onfocusout="formatRG()" required>
      </div>
    </div>
   ...
   <div class="form-section">
      ...
      <div id="main-CEP">
        ...
        <input type="text" class="form-control" id="inCEP" name="inCEP" placeholder="EX: 49044484" maxlength="8" onfocusout="formatCEP();" required>
      </div>
      <div>
      ...
      <div>
        <label for="validationDefault05" class="form-label">N°</label>
        <input type="text" class="form-control" id="inNum" name="inNum">
      </div>
      <div>
    ...
    <div class="form-section">
      ...
      <div>
        ...
        <input type="text" class="form-control" id="inTel" name="inTel" maxlength="11" placeholder="EX: 13982095384" onfocusout="formatarTel()" required>
      </div>
      <div>
    ...
    <div class="form-buttons">
      ...
      <button class="btn btn-primary btn-danger" type="reset" id="btLimparCampos">Limpar Campos</button>
    </div>
  </div>
</form>
...
if(!empty($_POST))
{
  ...
  try {
    if ($conn) {
      ...
      $stmt = $conn->prepare("INSERT INTO cliente (nome , cpf , rg , cep , rua , numero , bairro , cidade , complemento , uf , telefone , email)  
                                           VALUES (:nome, :cpf, :rg, :cep, :rua, :numero, :bairro, :cidade, :complemento, :uf, :telefone, :email)"); //INSTRUÇÃO SQL

      $stmt->bindParam(':nome', $nome);
      $stmt->bindParam(':cpf', $cpf);
      $stmt->bindParam(':rg', $rg);
      $stmt->bindParam(':cep', $cep);
      $stmt->bindParam(':rua', $rua);                // REFERENCIAS PARA ENVIAR O CONTEÚDO DAS VARIÁVEIS PARA O INSERT
  ...
  if ($extImg != "") {
      if (in_array($extImg, $validExt)) {
          if (filesize($_FILES['inImagem']['tmp_name']) <= 50000000) {  // Note: Changed 'name' to 'tmp_name' for filesize check
              ...
              move_uploaded_file($_FILES['inImagem']['tmp_name'], "/arquivos/Cliente/" . $novoNome);
          } else {
              echo "<script>
  ...
  $dados = array("Nome: ", "CPF: ", "RG: ", "CEP: ", "Rua: ", "N°: ", "Bairro: ", "Cidade: ", "Complemento: ", "UF: ", "Telefone: ", "E-mail: ", "Imagem: ");
  $cliente = array($_POST['inNome'], $_POST['inCPF'], $_POST['inRG'], $_POST['inCEP'], $_POST['inRua'], $_POST['inNum'], $_POST['inBairro'], $_POST['inCidade'], $_POST['inComplemento'], $_POST['inUF'], $_POST['inTel'], $_POST['inMail'], $_POST['inImagem']);
...
";
  ...
  $caminho = "config/cliente.txt"; //caminho onde sera criado o arquivo
